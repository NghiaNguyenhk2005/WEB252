...
<head>
    ...
    <title>Admin Panel – <?= htmlspecialchars($globalSettings['site_name'] ?? 'TechSaaS') ?></title>
    <!-- Bootstrap 5 -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome 6 (Srtdash uses FA) -->
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .srt-topbar .topbar-left { display: flex; align-items: center; gap: 12px; }
        .srt-topbar .topbar-right { display: flex; align-items: center; gap: 16px; }
        .srt-sidebar-toggle {
        ...
        .btn-srt-sm { padding: 4px 10px; font-size: .78rem; border-radius: 5px; }

        /* ── Pagination ── */
        .srt-pagination { display: flex; gap: 6px; flex-wrap: wrap; margin-top: 16px; }
        .srt-pagination a, .srt-pagination span {
            padding: 6px 12px; border-radius: 6px; font-size: .82rem; font-weight: 700;
            text-decoration: none; border: 1px solid #e2e8f0; color: #555;
            transition: all .2s;
        }
        ...
        @media (max-width: 768px) {
            ...
            .srt-topbar, .srt-main { left: 0; margin-left: 0; }
        }
    </style>
</head>
<body>
    ...
    <div class="topbar-right">
        <div class="topbar-user">
            <div class="topbar-avatar">
                <?php if ($adminAvatar): ?>
                    <img src="/<?= htmlspecialchars($adminAvatar) ?>" alt="">
                <?php else: ?>
