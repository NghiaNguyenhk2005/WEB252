                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <?php if (!empty($globalSettings['site_logo'])): ?>
                            <img src="/<?= htmlspecialchars($globalSettings['site_logo']) ?>" alt="Logo"
                                 style="height:40px;object-fit:contain;border-radius:6px;background:#f8f9fc;padding:4px;border:1px solid #eee;">
                        <?php else: ?>
...
<div class="srt-card" id="sliders">
    <div class="srt-card-header">
        ...
        <button class="btn-srt-primary btn-srt-sm"
                onclick="document.getElementById('addSliderForm').classList.toggle('d-none')">
