...
<header id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item <?= $i === 0 ? 'active' : '' ?>">
            <img src="/<?= htmlspecialchars($sl['image_url']) ?>" class="carousel-image-bg"
                 alt="<?= htmlspecialchars($sl['title'] ?? 'Slide ' . ($i + 1)) ?>">
            <div class="container">
                <div class="carousel-caption col-lg-7 col-md-9">
                    ...
                    <?php if ($sl['button_text'] && $sl['button_link']): ?>
                        <a href="<?= htmlspecialchars($sl['button_link']) ?>" class="btn btn-gradient btn-lg px-5 rounded-pill">
        ...
        <div class="carousel-item active">
            ...
            <div class="container">
                <div class="carousel-caption col-lg-7 col-md-9">
                    ...
                    <a href="/contact" class="btn btn-gradient btn-lg px-5 rounded-pill">Khám phá</a>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="container">
                <div class="carousel-caption col-lg-7 col-md-9">
                    ...
                    <a href="/contact" class="btn btn-light text-primary btn-lg px-5 rounded-pill">Xem chứng chỉ</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-4 border-bottom bg-white">
    <div class="container text-center">
        <p class="text-muted small fw-bold mb-4 text-uppercase" data-aos="fade-up">
            Được tin dùng bởi 500+ doanh nghiệp
        </p>
        <div class="row justify-content-center align-items-center opacity-75" data-aos="fade-up" data-aos-delay="100">
            <div class="col-4 col-md-2 mb-3">
                <img src="https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg" class="partner-logo" alt="Google">
            </div>
            <div class="col-4 col-md-2 mb-3">
                <img src="https://upload.wikimedia.org/wikipedia/commons/9/96/Microsoft_logo_%282012%29.svg" class="partner-logo" alt="Microsoft">
            </div>
            <div class="col-4 col-md-2 mb-3">
                <img src="https://upload.wikimedia.org/wikipedia/commons/a/a9/Amazon_logo.svg" class="partner-logo" alt="Amazon">
            </div>
            <div class="col-4 col-md-2 mb-3">
                <img src="https://upload.wikimedia.org/wikipedia/commons/0/08/Cisco_logo_blue_2016.svg" class="partner-logo" alt="Cisco">
            </div>
            <div class="col-4 col-md-2 mb-3">
                <img src="https://upload.wikimedia.org/wikipedia/commons/5/51/IBM_logo.svg" class="partner-logo" alt="IBM">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container my-5">
        <div class="row align-items-center mb-5 pb-5 border-bottom">
            <div class="col-lg-5" data-aos="fade-right">
                ...
                <p class="text-muted lead">
                    Loại bỏ sự phân mảnh dữ liệu giữa các phòng ban. Mọi thông tin được xử lý
                    tập trung trên một Dashboard duy nhất với tốc độ mili-giây.
                </p>
        ...
        <div class="row align-items-center mt-5 pt-4">
            ...
            <div class="col-lg-5 offset-lg-1 order-1 order-lg-2" data-aos="fade-left">
                ...
                <p class="text-muted lead">
                    Không giới hạn không gian làm việc. Ứng dụng di động được tối ưu bằng framework
                    Native mang lại trải nghiệm mượt mà không độ trễ.
                </p>
                <a href="/contact" class="btn btn-outline-primary rounded-pill px-4 mt-3">Liên hệ tư vấn</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container py-4">
        <div class="row text-center">
            <div class="col-md-3 col-6 mb-4 mb-md-0" data-aos="zoom-in" data-aos-delay="0">
                ...
                <p class="text-muted fw-medium mb-0">Uptime Đảm bảo</p>
            </div>
            <div class="col-md-3 col-6 mb-4 mb-md-0" data-aos="zoom-in" data-aos-delay="100">
                ...
                <p class="text-muted fw-medium mb-0">Doanh nghiệp</p>
            </div>
            <div class="col-md-3 col-6" data-aos="zoom-in" data-aos-delay="200">
                <h2 class="display-4 fw-bold text-primary mb-2">50M+</h2>
                <p class="text-muted fw-medium mb-0">Giao dịch/Ngày</p>
            </div>
            <div class="col-md-3 col-6" data-aos="zoom-in" data-aos-delay="300">
                <h2 class="display-4 fw-bold text-primary mb-2">24/7</h2>
                <p class="text-muted fw-medium mb-0">Hỗ trợ Kỹ thuật</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="0">
                <div class="card pricing-card h-100 p-4 bg-light">
                    <div class="card-body">
                        ...
                        <a href="/register" class="btn btn-outline-primary w-100 rounded-pill">Đăng ký ngay</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="card pricing-card popular h-100 p-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/register" class="btn btn-gradient w-100 rounded-pill">Dùng thử 14 ngày</a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-5 mb-5">
    <div class="container" data-aos="zoom-in">
        <div class="cta-section shadow-lg">
            ...
            <a href="/register" class="btn btn-light text-primary btn-lg px-5 rounded-pill shadow me-3 mb-3 mb-md-0">
                Tạo tài khoản miễn phí
            </a>
            <a href="/contact" class="btn btn-outline-light btn-lg px-5 rounded-pill mb-3 mb-md-0">
                Liên hệ tư vấn
            </a>
        </div>
    </div>
