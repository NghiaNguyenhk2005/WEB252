        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled text-secondary">
                    <li class="mb-2"><a href="#" class="text-secondary text-decoration-none">Tính năng</a></li>
                    <li class="mb-2"><a href="#" class="text-secondary text-decoration-none">Bảng giá</a></li>
                    <li class="mb-2"><a href="#" class="text-secondary text-decoration-none">Tài liệu API</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled text-secondary">
                    ...
                    <li class="mb-2"><a href="#" class="text-secondary text-decoration-none">Hỏi đáp (FAQ)</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6">
