...
\hline
\textbf{STT} & \textbf{Họ tên SV} & \textbf{MSSV} & \textbf{Lớp} & \textbf{\% Hoàn thành task}\\
\hline 
{1} & {Nguyễn Đức Nghĩa}& {2312266} & {L02} & \multirow{1}{*}{Task 1: 100\%}\\
\hline 
{2} & {Nguyễn Hoàng Minh Hiếu} & {2252211} & {L02} & \multirow{1}{*}{Task 2: 100\%}\\
\hline
\end{tabular}
