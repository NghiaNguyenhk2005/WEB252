...
\- Thiết kế trang chủ chuyên nghiệp, hiển thị thông tin tổng quan, dự án tiêu biểu.\\
& \- Xây dựng trang Liên hệ tích hợp bản đồ và form gửi yêu cầu trực tuyến. \\
\hline
Quản lý nội dung doanh nghiệp (Task 2) & 
\- Xây dựng module Giới thiệu (About Us) về lịch sử, tầm nhìn và đội ngũ.\\
& \- Thiết lập hệ thống Câu hỏi thường gặp (Q\&A) giúp giảm tải cho bộ phận hỗ trợ. \\
\hline
Quản trị hệ thống (Admin) & 
\- Tích hợp template \textbf{Srtdash} để quản lý toàn bộ cơ sở dữ liệu.\\
& \- Quản lý danh sách liên hệ khách hàng, cập nhật nội dung trang Giới thiệu và Q\&A. \\
\hline
Kỹ thuật và Bảo mật & 
\- Sử dụng PHP thuần, không Framework, đảm bảo mã nguồn đạt chuẩn W3C.\\
& \- Thực hiện validation dữ liệu phía Client (JS) và Server (PHP). \\
\hline
\end{tabular}
\end{table}
